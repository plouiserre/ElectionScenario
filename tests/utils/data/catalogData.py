...
from tests.utils.data.generateDataParties import load_all_parties, load_all_parties_with_candidates, load_all_parties_with_candidates_but_not_stability, load_all_parties_with_candidates_and_big_stability, load_parties_info
...
def __generate_party_datas(key):
    ...
    elif key =="parties_info":
        return load_parties_info()
    else: 
