...
class SeatDistributionRuleTest(unittest.TestCase):
    def test_choose_one_party_elected(self):
        ...
        seats_party = seat_distribution_rule.calculate(parties_votes, mode_design, 1)
    ...
    def test_choose_three_parties_elected(self):
        ...
        seats_party = seat_distribution_rule.calculate(parties_votes, mode_design, 3)
    ...
    def test_choose_ten_parties_elected(self):
        ...
        seats_party = seat_distribution_rule.calculate(parties_votes, mode_design, 12)
