...
class ProportionalDepartmentElectionServiceTest(unittest.TestCase):
    def test_determinate_congress_with_proportional_department_election(self):
        ...
        #LR 1
        assert_congress_person_with_district("RAY|Nicolas|MASCULIN|LR|21464|40.05|3ème circonscription|303|Allier|3", congress.parties[2].congress_persons[0], self)                          
        
        #DVD 1
        assert_congress_person_with_district("DESCOEUR|Vincent|MASCULIN|DVD|16615|37.66|1ère circonscription|1501|Cantal|15", congress.parties[3].congress_persons[0], self)        

        #ENS 4
        assert_congress_person_with_district("CAZENAVE|Thomas|MASCULIN|ENS|28564|38.31|1ère circonscription|3301|Gironde|33", congress.parties[4].congress_persons[0], self)
        assert_congress_person_with_district("COUILLARD|Bérangère|FEMININ|ENS|18854|33.12|7ème circonscription|3307|Gironde|33", congress.parties[4].congress_persons[1], self)
        assert_congress_person_with_district("POULLIAT|Eric|MASCULIN|ENS|25636|32.78|6ème circonscription|3306|Gironde|33", congress.parties[4].congress_persons[2], self)
        assert_congress_person_with_district("PANONACLE|Sophie|FEMININ|ENS|26881|31.71|8ème circonscription|3308|Gironde|33", congress.parties[4].congress_persons[3], self)
