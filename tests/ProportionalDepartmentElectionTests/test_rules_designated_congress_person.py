...
class RulesDesignatedCongressPersonTest(unittest.TestCase): 
    def test_one_congress_person_to_be_elected(self): 
        ...
        mode = rules_designated_congress_person.find(1, percentage_vote)
    ...
    def test_two_congress_persons_to_be_elected(self):
        ...
        mode = rules_designated_congress_person.find(2, percentage_vote)
    ...
    def test_three_congress_persons_to_be_elected(self):
        ...
        mode = rules_designated_congress_person.find(3, percentage_vote)
    ...
    def test_four_congress_persons_to_be_elected(self):
        ...
        mode = rules_designated_congress_person.find(4, percentage_vote)
    ...
    def test_five_congress_persons_to_be_elected(self):
        ...
        mode = rules_designated_congress_person.find(5, percentage_vote)
    ...
    def test_eighth_congress_persons_to_be_elected(self):
        ...
        mode = rules_designated_congress_person.find(8, percentage_vote)
