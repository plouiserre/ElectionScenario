...
from src.backend.infrastructure.models.factory_record import factory_candidate_record, factory_department_record, factory_district_record, factory_election_record, factory_elections_result_record, factory_party_record
from src.backend.infrastructure.services.mapper_to_domain import mapper_candidates_to_domain_person, mapper_parties_to_domain
...
class JsonResultsElection(ResultsElectionsPort):
    ...
    def get_results(self):
        ...
        all_parties = mapper_parties_to_domain(elections_results)
        all_candidates = mapper_candidates_to_domain_person(elections_results)
        elections = factory_elections(all_candidates, all_parties)
        return elections
    
    def __construct_elections_result(self):
        results = factory_elections_result_record([self.__construct_election()], self.__construct_departments(), 
                                                  self.__construct_parties())
        return results
