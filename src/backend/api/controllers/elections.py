...
from src.backend.api.controllers.dependency import get_one_turn_election_service, get_proportional_national_election_service, get_proportional_departmental_election_service
